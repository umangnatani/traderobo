...
namespace TradeRobo.Migrations
{
    ...
    [Migration("20200724161019_update16")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TradeRobo.Service.Trade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TradeRobo.Service.TradeBatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TradeRobo.Service.User", b =>
                {
                    ...
                    b.Property<string>("TDRefreshToken")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TDToken")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TradeRobo.Service.Trade", b =>
                {
                    b.HasOne("TradeRobo.Service.TradeBatch", "Batch")
                        .WithMany("Trades")
